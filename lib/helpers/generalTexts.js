...
exports.default = {
    ...
    imgExceed: "Sorry, atmost 2 images are allowed",
    ...
    foulOption: 'Swear words detected. This option will not be considered. Please resubmit another option.',
...
exports.textsWithInputs = {
    moreCharacters: (count) => `Your question should have ${count} more alphabetic characters. Elaborate further on your question or tell me if you want to end the flow so you can submit different text.`,
    notification: (question, answer) => `Hey, really sorry to interrupt the conversation but you opted in to be notified for the results of following question: ${question}.\nThe result is: '${answer}'.\n${answer == 'No option received majority' ? 'Since the poll has no winner, your credibility score will not be affected.' : 'Your credibility score will change shortly'} Please carry on with whatever was going on.`,
    greetings: (name) => `Hey ${name}, Welcome! I am the DilemmaBot, here to help you. Ask about questions and choices that bug you, anonymously. Get advice from people on the internet, and with my smart credibility calculation technique, have, maybe not perfect, but good assurance that the answer reflects opinions of general crowd, not personal biases.`,
    welcomeBack: (name) => `Welcome back ${name}! Ready to make another decision?`,
    results: (answer) => `So the answer based on the general consensus is\n'${answer}'`,
    askForMoreReplies: (num) => `You need to provide atleast ${2 - num} more replies for others to choose from.`,
    credibilityPositiveChange: (credibility) => `Great! Your credibility score has increased to ${credibility}. Keep up the good work 👍️.`,
    credibilityNegativeChange: (credibility) => `Uh oh! Your credibility score has decreased to ${credibility}. Try to keep your answers similar to general consensus.`,
    credibilityNoChange: (credibility) => `Your current credibility score is ${credibility}(out of 100).`
};
exports.noMatchTexts = ["Sorry I don't understand what you mean.", "Hmm, I have trouble understanding that.", "I think you should refer to the available services", "Please be a little more specific.", "Can you clarify what exactly you mean by that."];
exports.greetText = ['I think we have already met', 'Hello again', 'Greeting!', 'We have greeted each other before.'];
